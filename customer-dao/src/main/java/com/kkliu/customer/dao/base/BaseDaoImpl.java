 ...
 */
package com.kkliu.customer.dao.base;
...
public abstract class BaseDaoImpl<T, KEY extends Serializable> extends MyBatisSupport implements BaseDao<T, KEY> {
	...
	private static final String DEFAULT_USER_ORDERS_LIST = "userOrderlist";
	private static final String DEFAULT_USER_ORDERS_COUNT = "userOrderCount";
	...
	public List<Orders> userOrderlist(int id) {
		return this.selectList(getNameSpace(DEFAULT_USER_ORDERS_LIST), id);
	}
